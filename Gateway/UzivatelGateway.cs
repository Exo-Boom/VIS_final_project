...
{
    public class UzivatelGateway
    {
        public int Insert(string jmeno, string prijmeni, string email, string psc, string mesto, string zeme, string ulice, string heslo, string telefon, int roleId)
        {
